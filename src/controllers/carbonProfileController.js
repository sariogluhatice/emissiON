...
const updateCarbonProfile = async (req, res) => {
    ...
    try {
        // Mevcut cevapları çek ve yeni güncellemelerle birleştir
        ...
        // Birincil JSONB deposunu güncelle
        await pool.query(
        ...
        // Role'e göre normalize edilmiş tabloyu güncelle
        if (role === 'individual') {
